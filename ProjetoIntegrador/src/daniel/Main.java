...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[][] tabelaGeral = new String[2295][6]; //Irá armazenar Nome, CPF, Nome da Peça, Turno, Area, poltrona.
        String[] VendaCliente = new String[6];
        int v = 0; //Iteração para esse vetor VendaCliente.
        int linhaTabelaGeral = 0;

        //Loop para rodar a aplicação enquanto tiver clientes comprando ingressos.
